...
import org.jaffamq.persistence.database.actor.group.GroupRepositoryReadActor;
...
public class GroupRepositoryReadActorTest extends RepositoryTest {
    ...
    public ExternalResource systemResource = new ExternalResource() {
        ...
        protected void before() {
            ...
            final Props props = Props.create(GroupRepositoryReadActor.class, repository, getDataSource());
    ...
    public void shouldReturnListOfGroups() {
        ...
        new JavaTestKit(system) {{
            ...
            List<Group> groups = ((EntityListResponse) received).getPage();
    ...
    public void shouldReturnUserFoundForGetById() {
        ...
        new JavaTestKit(system) {{
            ...
            //  then
            assertThat((Group) response.getEntity(), allOf(
                    hasName("admins"),
                    hasId(1L)));
    ...
    public void shouldDetectUniqueName() {
        new JavaTestKit(system) {{
            ...
            //  when
            actor.tell(new IsUniqueRequest(UserDefaults.ADMINS_GROUP), getRef());
